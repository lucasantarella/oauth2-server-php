...
class OauthClients extends \Phalcon\Mvc\Model
{
    ...
    {
        $this->setSource("'".$this->getDI()->getShared(Phalcon::KEY_PHALCON_CONFIG_ARRAY)['client_table']."'");
    ...
    {
        return $this->getDI()->getShared(Phalcon::KEY_PHALCON_CONFIG_ARRAY)['client_table'];
    }
